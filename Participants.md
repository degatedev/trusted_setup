...
**If you are using AWS cloud servers, you can simplify the configuration and execution of the entire process using AWS CloudFormation. See details at: [Instructions for Participants using AWS CloudFormation](https://github.com/degatedev/trusted_setup/blob/degate1.1.0/Participants%20using%20AWS%20CloudFormation.md)**
