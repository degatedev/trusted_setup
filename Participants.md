...
```console
sudo docker run --name trust -v /opt/trustmount:/opt/trustmount -itd degate/trusted-setup-participants:1.0.0  <Sequence Number>  <Hash value from the previous contribution file> <Random Text>
```
...
```console
sudo docker run --name trust -v /opt/trustmount:/opt/trustmount -itd degate/trusted-setup-participants:1.0.0 2 0x376caae67d3e5e4bf05c1253ed364dcb40502166ec0bc492408b4a96d28f806b As5unTfkCLyXFcFEoWncTWpGwhgZXmfeLcHE
```
